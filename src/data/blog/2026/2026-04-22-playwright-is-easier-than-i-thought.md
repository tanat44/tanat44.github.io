...
Probably not. As I mentioned, I do believe that top priority on new project is to prove / deliver the value. However, when the feature sets are getting stable, brains are getting full, we start losing tracks of classes - how they are interacted, I think it's a good time to start writing tests.